...
{
    internal sealed class OutOfLeveSystem : SystemCollectionProviderBase<ILevelCollidable>, IRefreshable
    {
        private readonly ILevel _level;
        private readonly ICollisionCreateProvider _collisionCreateProvider;

        internal OutOfLeveSystem(ILevel level, ICollisionCreateProvider collisionCreateProvider) : base()
        {
